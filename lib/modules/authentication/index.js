...
const spotifyClientId = '3ad48b31d36c4c3c9c8f97377d33cb00';
const spotifyClientSecret = 'cb15621f6a68444698b36ad09f6385b3';
...
class OAuthModule {
	constructor(client) {
		...
		this._requestHandlers.set('authentication.spotify.get_authentication_details', async request => {
			const data = {
